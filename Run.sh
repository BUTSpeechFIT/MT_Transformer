...
only_scoring='False'
scoring_path='/mnt/matylda3/vydana/HOW2_EXP/MT_Transformer/MT_TransV1'
stage=3
...
stdbuf -o0  python /mnt/matylda3/vydana/HOW2_EXP/MT_Transformer/MT_TransV1/Make_training_scps.py \
						--data_dir $data_dir \
...
# #---------------------------------------------------------------------------------------------
stdbuf -o0  python /mnt/matylda3/vydana/HOW2_EXP/MT_Transformer/MT_Training.py \
						--data_dir $data_dir \
 						--gpu $gpu \
 						--train_path $train_path \
 						--dev_path $dev_path \
...
/mnt/matylda3/vydana/HOW2_EXP/Gen_V1/ATTNCODE/Basic_Attention_V1/utils/queue.pl \
	...
	python /mnt/matylda3/vydana/HOW2_EXP/MT_Transformer/MT_Decoding.py \
	--gpu $gpu \
	--model_dir $model_dir \
	--Decoding_job_no JOB \
	--beam $beam \
